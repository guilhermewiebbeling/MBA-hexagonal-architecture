...
public class ConsumerQueueGateway implements QueueGateway {
    ...
    public ConsumerQueueGateway(final CreateTicketForCustomerUseCase createTicketForCustomerUseCase, ObjectMapper mapper) {
    ...
    private <T> T safeRead(String content, Class<T> tClass) {
        try {
