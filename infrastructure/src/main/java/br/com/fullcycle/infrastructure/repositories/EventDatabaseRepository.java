...
public class EventDatabaseRepository implements EventRepository {
    ...
    public EventDatabaseRepository(final EventJpaRepository EventJpaRepository, final OutboxJpaRepository outboxJpaRepository, ObjectMapper mapper) {
    ...
    private Event save(Event event) {
        this.outboxJpaRepository.saveAll(event.allDomainEvents().stream()
